...
extern const struct spinand_manufacturer esmt_c8_spinand_manufacturer; /*add esmt mid 0xc8*/
extern const struct spinand_manufacturer esmt_2c_spinand_manufacturer; /*add esmt mid 0x2c*/
